...
import { useHeroAnimations } from '../../utils/useGSAPAnimations';
      ...
      <div className="relative flex h-screen w-full items-center justify-center">
        ...
        >
          <div className="flex flex-col items-center gap-y-6 rounded-xl bg-gray-800/40 p-6 text-center shadow-lg backdrop-blur-sm">
            ...
            >
              I'm <span className="amar-name text-[#e6ff99]">Amar Chauhan</span>.
            </h1>

            {/* Paragraphs */}
            <p 
              ref={paragraphsRef}
              className="prose-sm text-lg text-[#e6ff99] sm:prose-base lg:prose-lg"
            >
            ...
            <p 
              ref={paragraphsRef}
              className="prose-sm text-[#e6ff99] sm:prose-base lg:prose-lg"
            >
        ...
        <div 
          ...
          className="absolute inset-x-0 bottom-6 flex justify-center z-10"
        >
          <a
